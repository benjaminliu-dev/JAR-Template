...
/*---------------------------------------------------------------------------*/
vex::motor LeftF(PORT1, ratio6_1, false);
vex::motor LeftB(PORT2, ratio6_1, true);
vex::motor RightF(PORT16, ratio6_1, false);
vex::motor RightB(PORT4, ratio6_1, true);
...
Drive chassis(
    ...
    // Left Motors:
    motor_group(LeftB, LeftF),

    // Right Motors:
    motor_group(RightB, RightF),
